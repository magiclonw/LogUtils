...
public final class KLog {
    ...
    public static void e(int index,String tag, Object... objects) {
        printLog(E, index,tag, objects);
    }
    ...
    public static void json(String jsonFormat,int index) {
    ...
    private static void printLog(int type, String tagStr, Object... objects) {
        ...
        String[] contents = wrapperContent(STACK_TRACE_INDEX_6, tagStr, objects);
        String tag = contents[0];
        String msg = contents[1];
        String headString = contents[2];
        ...
        switch (type) {
            case V:
            case D:
                JsonLog.printJson(D,tag, msg, headString);
                break;
            case I:
                JsonLog.printJson(I,tag, msg, headString);
                break;
            case W:
                JsonLog.printJson(W,tag, msg, headString);
                break;
            case E:
                JsonLog.printJson(E,tag, msg, headString);
                break;
            case A:
...
//                break;
    ...
    private static void printLog(int type,int index, String tagStr, Object... objects) {

        if (!IS_SHOW_LOG) {
            return;
        }

        String[] contents = wrapperContent(index, tagStr, objects);
        String tag = contents[0];
        String msg = contents[1];
        String headString = contents[2];
        ...
        switch (type) {
            ...
            case E:
            case JSON:
                JsonLog.printJson(type,tag, msg, headString);
                break;
            case XML:
                XmlLog.printXml(tag, msg, headString);
                break;
